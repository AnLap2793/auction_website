...
User.hasMany(AuctionWinner, { foreignKey: "user_id" });
AuctionWinner.belongsTo(User, { foreignKey: "user_id" });

// AuctionWinner - Transaction (1:n) - Optional relationship
AuctionWinner.hasMany(Transaction, { foreignKey: "auction_id", constraints: false });
Transaction.belongsTo(AuctionWinner, { foreignKey: "auction_id", constraints: false });
